...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if middle_finger_tip and ring_finger_tip and pinky_tip is not None:
                # Di chuyển nhân vật về phía trước
                print("Di chuyển về phía trước")
            if thumb_tip and index_finger_tip and middle_finger_tip and ring_finger_tip and pinky_tip is None:
